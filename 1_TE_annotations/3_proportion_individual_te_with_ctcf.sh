...
tad=${dir_in}/TADs/TAD_boundaries_${tissue}.ctcf.bed.gz
loop=${dir_in}/loop_anchors/loop_anchors_${tissue}.ctcf.bed.gz


# OUTPUT
dir_out=${workdir}/2_dynamic
out=${dir_out}/fraction_ctcf_of_TE_in_${tissue}.txt
