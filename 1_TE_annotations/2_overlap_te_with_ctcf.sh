...
out=${dir_out}/ctcf_states_overlap_${te}.txt
...
do
        ...
        out_tissue=${dir_out}/ctcf_states_overlap_${te}_in_${tissue}.txt
	bound=${dir_in}/TADs/TAD_boundaries_${tissue}.ctcf.bed.gz
	anchors=${dir_in}/loop_anchors/loop_anchors_${tissue}.ctcf.bed.gz
...
paste ${dir_out}/ctcf_states_overlap_${te}_in_{brain,muscle}.txt |
