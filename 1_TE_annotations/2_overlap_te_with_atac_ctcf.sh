...
out=${dir_out}/atac_ctcf_states_overlap_${te}.txt
...
do
        ...
        out_tissue=${dir_out}/atac_ctcf_states_overlap_${te}_in_${tissue}.txt
	bound=${dir_in}/TADs/TAD_boundaries_${tissue}.atac_ctcf.bed.gz
	anchors=${dir_in}/loop_anchors/loop_anchors_${tissue}.atac_ctcf.bed.gz
...
paste ${dir_out}/atac_ctcf_states_overlap_${te}_in_{brain,muscle}.txt |
