...
# INPUT DATA
bed_prom=../0_CRE_file_prepared/universal/uni_active_promoter.bed.gz
bed_weak=../0_CRE_file_prepared/universal/uni_weak_promoter.bed.gz
bed_enhc=../0_CRE_file_prepared/universal/uni_active_enhancer.bed.gz

bed_prox=../0_CRE_file_prepared/universal/uni_proximal_ATAC.bed.gz
bed_dist=../0_CRE_file_prepared/universal/uni_distal_ATAC.bed.gz

bed_umr=../0_CRE_file_prepared/universal/uni_UMR.bed.gz
bed_lmr=../0_CRE_file_prepared/universal/uni_LMR.bed.gz



# OUTPUT
dir_out=`pwd`
out_prom=${dir_out}/subfam_enriched_active_promoter_univ.txt
out_weak=${dir_out}/subfam_enriched_weak_promoter_univ.txt
out_enhc=${dir_out}/subfam_enriched_enhancer_univ.txt

out_prox=${dir_out}/subfam_enriched_proximal_ATAC_univ.txt
out_dist=${dir_out}/subfam_enriched_distal_ATAC_univ.txt

out_umr=${dir_out}/subfam_enriched_UMR_univ.txt
out_lmr=${dir_out}/subfam_enriched_LMR_univ.txt
...
do
    ...
    if [ $cnt_prom_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tActive_promoter\t$bp_prom_te\t$len_te\t$len_prom" >> $out_prom
    ...
    if [ $cnt_weak_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tWeak_promoter\t$bp_weak_te\t$len_te\t$len_weak" >> $out_weak
    ...
    if [ $cnt_enhc_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tActive_enhancer\t$bp_enhc_te\t$len_te\t$len_enhc" >> $out_enhc
    ...
    if [ $cnt_prox_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tProximal_ATAC\t$bp_prox_te\t$len_te\t$len_prox" >> $out_prox
    ...
    if [ $cnt_dist_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tDistal_ATAC\t$bp_dist_te\t$len_te\t$len_dist" >> $out_dist
    ...
    if [ $cnt_umr_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tUMR\t$bp_umr_te\t$len_te\t$len_umr" >> $out_umr
    ...
    if [ $cnt_lmr_te -le 10 ]; then
        lor="NA"; fi
    echo -e "$lor\t$name_te\tUniversal\tLMR\t$bp_lmr_te\t$len_te\t$len_lmr" >> $out_lmr
